...
function(surgsim_add_library LIBRARY_NAME SOURCE_FILES HEADER_FILES HEADER_DIRECTORY)
	if (SOURCE_FILES)
		...
		STRING(REGEX REPLACE "^SurgSim" "" MODULE_NAME ${LIBRARY_NAME})
		STRING(TOUPPER ${MODULE_NAME} MODULE_NAME_UPPER)

		configure_file(${CMAKE_SOURCE_DIR}/CMake/Library.h.in
			"${PROJECT_BINARY_DIR}/${HEADER_DIRECTORY}/${MODULE_NAME}.h" @ONLY)
