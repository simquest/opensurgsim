...
class SetBoundaryCondition(bpy.types.Operator):
    ...
    bl_label = "Set Boundary Condition"
...
def menu_func(self,context):
    self.layout.operator(SetBoundaryCondition.bl_idname)

def register():
    bpy.utils.register_class(SetBoundaryCondition)
    bpy.types.VIEW3D_MT_edit_mesh.append(menu_func)


def unregister():
    bpy.utils.unregister_class(SetBoundaryCondition)
