...
static void setProblemInputs(Dynamic_Matrix<double>& HCHt, Dynamic_Vector<double>& E, Dynamic_Vector<double>& mu,
                             std::vector<MLCP_Constraint>& constraintTypes)
{
	const int size = 16;

	HCHt.resizeUpIfNecessary(size, size);
...
void setGaussSeidelOutputs(Dynamic_Vector<double>& lambda)
{
	const int size = 16;

	lambda.resizeUpIfNecessary(size);
...
static MlcpTestProblem problem;
