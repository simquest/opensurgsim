...
TEST_F(TriangleMeshBaseTest, GetTriangleVerticesPositions)
{
	MockTriangleMeshBase mesh;
	...
	// Testing
	for (unsigned int id = 0; id < mesh.getTriangles().size(); ++id)
	{
		auto verticesPositions = mesh.getTriangleVerticesPositions(id);
