...
#ifndef SURGSIM_DATA_STRUCTURES_MESH_ELEMENT_DATA_H
#define SURGSIM_DATA_STRUCTURES_MESH_ELEMENT_DATA_H
...
/// Abstract base class for data to be stored in a mesh element.
/// \sa	MeshElement
...
public:
	...
	MeshElementData();
	/// Destructor
	virtual ~MeshElementData();

	/// Compares the data and returns true if equal, false if not equal.
	bool operator==(const MeshElementData<N>& data) const;
...
private:
	...
	virtual bool isEqual(const MeshElementData<N>& data) const = 0;
};
