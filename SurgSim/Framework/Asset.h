...
/// functions implement an additional helper function `load<Asset>()` that creates and loads the specified asset.
/// Additionally a special YAML parameter should be implemented `<Asset>FileName` that can be used to specify
