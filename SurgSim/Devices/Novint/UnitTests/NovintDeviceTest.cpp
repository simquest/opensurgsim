...
{
	//NovintScaffold::setDefaultLogLevel(SurgSim::Framework::LOG_LEVEL_DEBUG);
	std::shared_ptr<NovintDevice> device = std::make_shared<NovintDevice>("TestNovint", "");
	ASSERT_TRUE(device != nullptr) << "Device creation failed.";
	EXPECT_FALSE(device->isInitialized());
	ASSERT_TRUE(device->initialize()) << "Initialization failed.  Is a Novint device plugged in?";
	EXPECT_TRUE(device->isInitialized());
...
TEST(NovintDeviceTest, Name)
{
	...
	std::shared_ptr<NovintDevice> device = std::make_shared<NovintDevice>("TestNovint", "Default Novint");
	ASSERT_TRUE(device != nullptr) << "Device creation failed.";
	EXPECT_EQ("TestNovint", device->getName());
...
{
	//NovintScaffold::setDefaultLogLevel(SurgSim::Framework::LOG_LEVEL_DEBUG);
	std::shared_ptr<NovintDevice> device1 = std::make_shared<NovintDevice>("Novint1", "Default Novint");
	...
	std::shared_ptr<NovintDevice> device2 = std::make_shared<NovintDevice>("Novint2", "Second Novint");
...
{
	//NovintScaffold::setDefaultLogLevel(SurgSim::Framework::LOG_LEVEL_DEBUG);
	std::shared_ptr<NovintDevice> device1 = std::make_shared<NovintDevice>("Novint", "Default Novint");
	ASSERT_TRUE(device1 != nullptr) << "Device creation failed.";
	ASSERT_TRUE(device1->initialize()) << "Initialization failed.  Is a Novint device plugged in?";

	std::shared_ptr<NovintDevice> device2 = std::make_shared<NovintDevice>("Novint", "Second Novint");
	ASSERT_TRUE(device2 != nullptr) << "Device creation failed.";
...
TEST(NovintDeviceTest, CreateDevicesWithSameInitializationName)
{
	...
	std::shared_ptr<NovintDevice> device2 = std::make_shared<NovintDevice>("Novint2", "Default Novint");
	ASSERT_TRUE(device2 != nullptr) << "Device creation failed.";
