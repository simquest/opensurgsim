...
///   | type       | name              |                                                                           |
///   | ----       | ----              | ---                                                                       |
///   | pose       | "pose"			   | %Hand pose (units are meters).											   |
///
...
public:
	...
	/// Set the position scale for the device.
	/// \param scale The position scale for the device.
	void setPositionScale(double positionScale);
...
private:
	...
	/// The scale applied to the position read from the Nimble device.
