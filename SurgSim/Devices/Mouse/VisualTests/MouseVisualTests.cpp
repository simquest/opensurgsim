...
struct TestListener : public SurgSim::Input::InputConsumerInterface
{
	...
	virtual void handleInput(const std::string& device, const DataGroup& inputData) override
	{
		...
		inputData.booleans().get(SurgSim::DataStructures::DataNames::button1, &button1);
		inputData.booleans().get(SurgSim::DataStructures::DataNames::button2, &button2);
		inputData.booleans().get(SurgSim::DataStructures::DataNames::button3, &button3);
