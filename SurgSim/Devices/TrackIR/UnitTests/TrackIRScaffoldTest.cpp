...
//	std::weak_ptr<TrackIRScaffold> scaffold1 = scaffold;
//	{
//		std::shared_ptr<TrackIRScaffold> stillHaveScaffold = scaffold1.lock();
...
//	scaffold.reset();
//	{
//		std::shared_ptr<TrackIRScaffold> dontHaveScaffold = scaffold1.lock();
...
//	std::weak_ptr<TrackIRScaffold> scaffold2 = scaffold;
//	{
//		std::shared_ptr<TrackIRScaffold> stillHaveScaffold = scaffold2.lock();
