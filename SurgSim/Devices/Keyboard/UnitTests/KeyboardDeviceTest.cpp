...
TEST(KeyboardDeviceTest, InputConsumer)
{
	...
	// 'device' object pushes input to 'consumer'
	// 'pushInput()' method is protected in 'CommmonDevice' class
	// Needs to figure out a way around this (without compromise encapsulation).
	//device->pushInput();
