	...
	SurgSim::Framework::Behavior(name)
{
	SURGSIM_ADD_SERIALIZABLE_PROPERTY(TransferPhysicsToGraphicsMeshBehavior,
		std::shared_ptr<SurgSim::Physics::Representation>, Source, getSource, setSource);
	SURGSIM_ADD_SERIALIZABLE_PROPERTY(TransferPhysicsToGraphicsMeshBehavior,
		std::shared_ptr<SurgSim::Graphics::Representation>, Target, getTarget, setTarget);
}

void TransferPhysicsToGraphicsMeshBehavior::setSource(
	const std::shared_ptr<SurgSim::Physics::Representation>& source)
{
...
void TransferPhysicsToGraphicsMeshBehavior::setTarget(
	const std::shared_ptr<SurgSim::Graphics::Representation>& target)
{
...
std::shared_ptr<SurgSim::Physics::Representation> TransferPhysicsToGraphicsMeshBehavior::getSource() const
{
	return m_source;
}
std::shared_ptr<SurgSim::Graphics::Representation> TransferPhysicsToGraphicsMeshBehavior::getTarget() const
{
	return m_target;
}
