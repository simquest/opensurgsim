...
std::shared_ptr<Graphics::RenderPass> createShadowMapPass(int textureSize, double bias, bool debug)
{
			...
			bool showDebug)
{
	...
	auto shadowMapPass = createShadowMapPass(shadowTextureSize, bias, showDebug);
