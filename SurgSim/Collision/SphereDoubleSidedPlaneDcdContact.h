...
#ifndef SURGSIM_COLLISION_SPHEREDDOUBLESIDEDPLANECDCONTACT_H
#define SURGSIM_COLLISION_SPHEREDDOUBLESIDEDPLANECDCONTACT_H
...
public:
	...
	{
		return std::pair<int,int>(RigidShapeType::RIGID_SHAPE_TYPE_SPHERE,
			RigidShapeType::RIGID_SHAPE_TYPE_DOUBLESIDEDPLANE);
	}
