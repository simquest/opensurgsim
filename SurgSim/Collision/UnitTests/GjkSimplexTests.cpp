...
TEST(GjkSimplexTest, SinglePointAsSimplex)
{
    ...
    // Case 1: The point is the origin.
    simplex.clear();
    ...
    // Case 2: The point is not the origin.
    simplex.clear();
...
TEST(GjkSimplexTest, LineSegmentAsSimplex)
{
    ...
    // Case 1: The first simplex point is the origin.
    simplex.clear();
    simplex.addVertex(Vector3d::Zero(), vertexA, vertexB);
    ...
    // Case 2: The second simplex point is the origin.
    simplex.clear();
    simplex.addVertex(Vector3d::Ones(), vertexA, vertexB);
    simplex.addVertex(Vector3d::Zero(), vertexA, vertexB);
    simplex.update(&closestPointToOrigin);
    ...
    // Case 3: The origin is within the line segment.
    simplex.clear();
    simplex.addVertex(Vector3d::Ones(), vertexA, vertexB);
    simplex.addVertex(-Vector3d::Ones(), vertexA, vertexB);
    simplex.update(&closestPointToOrigin);
    ...
    // Case 4: The first simplex point is the closest point to origin.
    simplex.clear();
    simplex.addVertex(Vector3d::Ones(), vertexA, vertexB);
    ...
    // Case 5: The second simplex point is the closest point to origin.
    simplex.clear();
    simplex.addVertex(Vector3d::Constant(5.0), vertexA, vertexB);
    simplex.addVertex(Vector3d::Ones(), vertexA, vertexB);
    simplex.update(&closestPointToOrigin);
    ...
    // Case 6: The closest point to origin is within the line segment.
    simplex.clear();
...
TEST(GjkSimplexTest, TriangleAsSimplex)
{
    ...
    // Case 3: The third simplex point is the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 2.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(2.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d::Zero(), vertexA, vertexB);
    ...
    // Case 4: The origin is within the line segment, ab.
    simplex.clear();
    ...
    // Case 5: The origin is within the line segment, bc.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 6: The origin is within the line segment, ca.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 7: The first simplex point is the closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 8: The second simplex point is the closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(2.0, 3.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(3.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 9: The third simplex point is the closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(3.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(2.0, 3.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 10: The origin is closest to the line segment, ab.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 11: The origin is closest to the line segment, bc.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 3.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 12: The origin is closest to the line segment, ca.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 3.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 13: The origin is within the triangle, abc.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 14: The origin is closest to the triangle, abc.
    simplex.clear();
    ...
    // Case 15: The origin is closest to the triangle, abc.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, -1.0, -0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, -0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, -0.1), vertexA, vertexB);
...
TEST(GjkSimplexTest, TetrahedronAsSimplex)
{
    ...
    // Case 4: The fourth simplex point is the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(2.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 2.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 1.0), vertexA, vertexB);
    ...
    // Case 5: The origin is within the line segment, ab.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 6: The origin is within the line segment, bc.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 0.5, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 7: The origin is within the line segment, cd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.5, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 8: The origin is within the line segment, da.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.5, 1.0), vertexA, vertexB);
    ...
    // Case 9: The origin is within the line segment, ac.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.0, 0.0), vertexA, vertexB);
    ...
    // Case 10: The origin is within the line segment, bd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.5, 1.0), vertexA, vertexB);
    ...
    // Case 11: The first simplex point is closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 1.0, 1.0), vertexA, vertexB);
    ...
    // Case 12: The second simplex point is closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(2.0, 2.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(3.0, 1.0, 1.0), vertexA, vertexB);
    ...
    // Case 13: The third simplex point is closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(2.0, 3.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(2.0, 2.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 1.0, 1.0), vertexA, vertexB);
    ...
    // Case 14: The fourth simplex point is closest to the origin.
    simplex.clear();
    simplex.addVertex(Vector3d(3.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(2.0, 3.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(2.0, 2.0, 2.0), vertexA, vertexB);
    ...
    // Case 15: The origin is closest to the line segment, ab.
    simplex.clear();
    ...
    // Case 16: The origin is closest to the line segment, bc.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.5, 0.0), vertexA, vertexB);
    ...
    // Case 17: The origin is closest to the line segment, cd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.5, 0.0), vertexA, vertexB);
    ...
    // Case 18: The origin is closest to the line segment, da.
    simplex.clear();
    simplex.addVertex(Vector3d(1.0, 0.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 1.0), vertexA, vertexB);
    ...
    // Case 19: The origin is closest to the line segment, ac.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, 0.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, 0.5, 0.0), vertexA, vertexB);
    ...
    // Case 20: The origin is closest to the line segment, bd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, 0.5, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.5, 0.0), vertexA, vertexB);
    ...
    // Case 21: The origin is within the triangle, abc.
    simplex.clear();
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    ...
    // Case 23: The origin is within the triangle, bcd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, 0.0), vertexA, vertexB);
    ...
    // Case 24: The origin is closest to the triangle, bcd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, 0.1), vertexA, vertexB);
    ...
    // Case 25: The origin is within the triangle, cda.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.0), vertexA, vertexB);
    ...
    // Case 26: The origin is closest to the triangle, cda.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.1), vertexA, vertexB);
    ...
    // Case 25: The origin is within the triangle, abd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    ...
    // Case 26: The origin is closest to the triangle, abd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 0.1), vertexA, vertexB);
    simplex.addVertex(Vector3d(0.0, 0.0, 2.0), vertexA, vertexB);
    ...
    // Case 27: The origin is within the tetrahedron, abcd.
    simplex.clear();
    simplex.addVertex(Vector3d(0.0, 1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(-1.0, -1.0, 1.0), vertexA, vertexB);
    simplex.addVertex(Vector3d(1.0, -1.0, 1.0), vertexA, vertexB);
