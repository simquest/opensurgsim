...
#ifndef SURGSIM_COLLISION_OCTREEPLANEDCDCONTACT_H
#define SURGSIM_COLLISION_OCTREEPLANEDCDCONTACT_H
...
class OctreePlaneDcdContact : public OctreeDcdContact
{
public:
	/// Constructor.
	OctreePlaneDcdContact();

	/// Destructor.
	virtual ~OctreePlaneDcdContact();
...
private:
	BoxPlaneDcdContact m_calculator;
};

};
};

#endif //SURGSIM_COLLISION_OCTREEPLANEDCDCONTACT_H
