...
OctreeDoubleSidedPlaneDcdContact::OctreeDoubleSidedPlaneDcdContact()
{
}
...
{
	return m_calculator.calculateContact(boxShape, boxPose, static_cast<const DoubleSidedPlaneShape&>(otherShape),
			otherPose);
}
