...
OctreeCapsuleDcdContact::OctreeCapsuleDcdContact()
{
}
...
{
	return m_calculator.calculateContact(boxShape, boxPose, static_cast<const CapsuleShape&>(otherShape), otherPose);
}
