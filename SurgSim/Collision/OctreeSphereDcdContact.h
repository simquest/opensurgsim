...
#ifndef SURGSIM_COLLISION_OCTREESPHEREDCDCONTACT_H
#define SURGSIM_COLLISION_OCTREESPHEREDCDCONTACT_H
...
private:
	BoxSphereDcdContact m_calculator;
};

};
};

#endif //SURGSIM_COLLISION_OCTREESPHEREDCDCONTACT_H
