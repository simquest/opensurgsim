...
#ifndef SURGSIM_COLLISION_OCTREEDOUBLESIDEDPLANEDCDCONTACT_H
#define SURGSIM_COLLISION_OCTREEDOUBLESIDEDPLANEDCDCONTACT_H
...
public:
	/// Constructor.
	OctreeDoubleSidedPlaneDcdContact();

	/// Destructor.
	virtual ~OctreeDoubleSidedPlaneDcdContact();
...
#endif //SURGSIM_COLLISION_OCTREEDOUBLESIDEDPLANEDCDCONTACT_H
