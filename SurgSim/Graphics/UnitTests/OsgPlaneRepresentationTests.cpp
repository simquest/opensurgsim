...
{
	ASSERT_NO_THROW({std::shared_ptr<Representation> representation = std::make_shared<OsgPlaneRepresentation>("test name");});
...
TEST(OsgPlaneRepresentationTests, RenderTest)
{
	...
	std::shared_ptr<PlaneRepresentation> planeRepresentation1 = std::make_shared<OsgPlaneRepresentation>("plane representation 1");
	viewElement->addComponent(planeRepresentation1);
	std::shared_ptr<PlaneRepresentation> planeRepresentation2 = std::make_shared<OsgPlaneRepresentation>("plane representation 2");
