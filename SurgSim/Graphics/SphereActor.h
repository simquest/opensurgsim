...
/// Base graphics sphere actor class, which defines the basic interface for a sphere that can be visualized.
/// The sphere center is at (0, 0, 0).
class SphereActor : public virtual Actor
{
public:
	/// Constructor
	/// \param	name	Name of the actor
	/// \post	The sphere radius is 1.0.
	explicit SphereActor(const std::string& name) : Actor(name)
	{
	}
