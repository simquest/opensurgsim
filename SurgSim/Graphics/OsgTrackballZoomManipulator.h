...
#ifndef SURGSIM_GRAPHICS_TRACKBALLZOOMMANIPULATOR
#define SURGSIM_GRAPHICS_TRACKBALLZOOMMANIPULATOR
...
To apply the zoom, get the value from getZoomFactor() and multiply it by some base FOV to calculate the FOV for the current zoom level.
*/
