...
public:
	...
	/// There is 2 ways to define a rigid actor mass/inertia:
	...
	/// Get the mass density of the rigid actor
	...
	/// Add a shape to this rigid actor
	/// \param shape A shape to add to this rigid actor
	void addShape(const std::shared_ptr<RigidShape> shape)
	{
		m_shapes.push_back(shape);
	}

	/// Remove a shape from this rigid actor
	/// \param shape The shape to be detached from this rigid actor
	...
	/// Get all the shapes associated to this rigid actor
...
private:
	...
	/// Shapes associated to this rigid actor
