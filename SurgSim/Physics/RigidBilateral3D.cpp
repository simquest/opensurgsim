...
RigidBilateral3D::RigidBilateral3D()
{
}
...
void RigidBilateral3D::doBuild(double dt,
...
SurgSim::Math::MlcpConstraintType RigidBilateral3D::getMlcpConstraintType() const
{
	return SurgSim::Math::MLCP_BILATERAL_3D_CONSTRAINT;
}

size_t RigidBilateral3D::doGetNumDof() const
{
	return 3;
}
