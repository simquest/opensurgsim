...
#ifndef SURGSIM_PHYSICS_RIGIDCONSTRAINTBILATERAL3D_H
#define SURGSIM_PHYSICS_RIGIDCONSTRAINTBILATERAL3D_H
...
class RigidConstraintBilateral3D : public ConstraintImplementation
{
public:
	/// Constructor
	RigidConstraintBilateral3D();

	/// Destructor
	virtual ~RigidConstraintBilateral3D();
...
#endif // SURGSIM_PHYSICS_RIGIDCONSTRAINTBILATERAL3D_H
