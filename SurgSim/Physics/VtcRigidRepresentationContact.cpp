...
#include <SurgSim/Physics/VtcRigidRepresentationContact.h>
...
VtcRigidRepresentationContact::VtcRigidRepresentationContact()
{
}
...
void VtcRigidRepresentationContact::doBuild(double dt,
											...
											ConstraintSideSign sign)
{
	...
	std::shared_ptr<Representation> representation = localization->getRepresentation();
	  std::shared_ptr<VtcRigidRepresentation> rigid = std::static_pointer_cast<VtcRigidRepresentation>(representation);
...
SurgSim::Math::MlcpConstraintType VtcRigidRepresentationContact::getMlcpConstraintType() const
{
	return SurgSim::Math::MLCP_UNILATERAL_3D_FRICTIONLESS_CONSTRAINT;
}

SurgSim::Physics::RepresentationType VtcRigidRepresentationContact::getRepresentationType() const
{
	return REPRESENTATION_TYPE_VTC_RIGID;
}

unsigned int VtcRigidRepresentationContact::doGetNumDof() const
{
	return 1;
}
