...
#ifndef SURGSIM_PHYSICS_FEM3DBILATERAL3D_H
#define SURGSIM_PHYSICS_FEM3DBILATERAL3D_H
...
class Fem3DBilateral3D : public ConstraintImplementation
{
public:
	/// Constructor
	Fem3DBilateral3D();
...
#endif // SURGSIM_PHYSICS_FEM3DBILATERAL3D_H
