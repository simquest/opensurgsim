...
#ifndef SURGSIM_PHYSICS_FEM3DREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
#define SURGSIM_PHYSICS_FEM3DREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
...
/// Fem3DRepresentation 3d rotation vector constraint implementation.
///
/// This constraint belongs to the family of bilateral3D constraints enforcing equality between 3 dofs.
class Fem3DRepresentationConstraintRotationVector : public ConstraintImplementation
{
public:
	/// Constructor
	Fem3DRepresentationConstraintRotationVector();

	/// Destructor
	virtual ~Fem3DRepresentationConstraintRotationVector();
...
#endif // SURGSIM_PHYSICS_FEM3DREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
