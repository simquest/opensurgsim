...
#ifndef SURGSIM_PHYSICS_RIGIDREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
#define SURGSIM_PHYSICS_RIGIDREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
...
/// RigidRepresentation rotation vector constraint implementation.
///
/// It belongs to the family of bilateral3D constraints enforcing equality on 3 separate dofs.
class RigidRepresentationConstraintRotationVector : public ConstraintImplementation
{
public:
	/// Constructor
	RigidRepresentationConstraintRotationVector();

	/// Destructor
	virtual ~RigidRepresentationConstraintRotationVector();
...
private:
	...
	/// \return 3 A rotation vector constraint enforces equality in the x, y, and z dimensions between 2 vectors.
...
#endif // SURGSIM_PHYSICS_RIGIDREPRESENTATIONCONSTRAINTROTATIONVECTOR_H
