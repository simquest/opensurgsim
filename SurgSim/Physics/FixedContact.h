...
#ifndef SURGSIM_PHYSICS_FIXEDCONTACT_H
#define SURGSIM_PHYSICS_FIXEDCONTACT_H
...
class FixedContact : public ConstraintImplementation
{
public:
	/// Constructor
	FixedContact();
...
#endif  // SURGSIM_PHYSICS_FIXEDCONTACT_H
