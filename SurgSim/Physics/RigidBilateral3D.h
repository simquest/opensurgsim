...
#ifndef SURGSIM_PHYSICS_RIGIDBILATERAL3D_H
#define SURGSIM_PHYSICS_RIGIDBILATERAL3D_H
...
class RigidBilateral3D : public ConstraintImplementation
{
public:
	/// Constructor
	RigidBilateral3D();
...
#endif // SURGSIM_PHYSICS_RIGIDBILATERAL3D_H
