...
TEST_F(Fem1DLocalizationTest, SetGetRepresentation)
{
...
TEST_F(Fem1DLocalizationTest, SetGetLocalization)
{
...

	{
		...
		EXPECT_THROW(std::make_shared<Fem1DLocalization>(nullptr, m_validLocalPosition),
			SurgSim::Framework::AssertionFailure);
	}

	{
		...
		auto localization = std::make_shared<Fem1DLocalization>(m_fem, m_validLocalPosition);
...
TEST_F(Fem1DLocalizationTest, CalculatePositionTest)
{
