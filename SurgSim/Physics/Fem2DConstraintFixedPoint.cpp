...
Fem2DConstraintFixedPoint::Fem2DConstraintFixedPoint()
{
}
...
void Fem2DConstraintFixedPoint::doBuild(double dt,
...
SurgSim::Physics::ConstraintType Fem2DConstraintFixedPoint::getConstraintType() const
{
	return SurgSim::Physics::FIXED_3DPOINT;
}

size_t Fem2DConstraintFixedPoint::doGetNumDof() const
{
	return 3;
}
