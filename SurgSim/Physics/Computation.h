...
public:
	...
	/// Sets up wether the computation will copy the state of PhysicsManagerState before executing.
	/// \param	val	Wether to create a copy of the PhysicsState before running the update fuction.
