...
Fem2DConstraintFrictionlessContact::Fem2DConstraintFrictionlessContact()
{
}
...
void Fem2DConstraintFrictionlessContact::doBuild(double dt,
...
{
	std::shared_ptr<Fem2DRepresentation> fem
		= std::static_pointer_cast<Fem2DRepresentation>(localization->getRepresentation());
	...
	const SurgSim::DataStructures::IndexedLocalCoordinate& coord
		= std::static_pointer_cast<Fem2DLocalization>(localization)->getLocalPosition();
...
SurgSim::Physics::ConstraintType Fem2DConstraintFrictionlessContact::getConstraintType() const
{
	return SurgSim::Physics::FRICTIONLESS_3DCONTACT;
}

size_t Fem2DConstraintFrictionlessContact::doGetNumDof() const
{
	return 1;
}
